defmodule Heroicons.Solid do
  ...
  def save_as(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M9.707 7.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L13 8.586V5h3a2 2 0 012 2v5a2 2 0 01-2 2H8a2 2 0 01-2-2V7a2 2 0 012-2h3v3.586L9.707 7.293zM11 3a1 1 0 112 0v2h-2V3z"></path><path d="M4 9a2 2 0 00-2 2v5a2 2 0 002 2h8a2 2 0 002-2H4V9z"></path>
    </svg>

    """
  end

  @doc "solid/document-search.svg"
  def document_search(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2h-1.528A6 6 0 004 9.528V4z"></path><path fill-rule="evenodd" d="M8 10a4 4 0 00-3.446 6.032l-1.261 1.26a1 1 0 101.414 1.415l1.261-1.261A4 4 0 108 10zm-2 4a2 2 0 114 0 2 2 0 01-4 0z" clip-rule="evenodd"></path>
    </svg>
  ...
  def folder_remove(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z"></path><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 11h4"></path>
    </svg>

    """
  end

  @doc "solid/terminal.svg"
  ...
  def folder_open(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1H8a3 3 0 00-3 3v1.5a1.5 1.5 0 01-3 0V6z" clip-rule="evenodd"></path><path d="M6 12a2 2 0 012-2h8a2 2 0 012 2v2a2 2 0 01-2 2H2h2a2 2 0 002-2v-2z"></path>
    </svg>

    """
  end

  @doc "solid/document-add.svg"
  ...
  def qrcode(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M3 4a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 01-1 1H4a1 1 0 01-1-1V4zm2 2V5h1v1H5zM3 13a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 01-1 1H4a1 1 0 01-1-1v-3zm2 2v-1h1v1H5zM13 3a1 1 0 00-1 1v3a1 1 0 001 1h3a1 1 0 001-1V4a1 1 0 00-1-1h-3zm1 2v1h1V5h-1z" clip-rule="evenodd"></path><path d="M11 4a1 1 0 10-2 0v1a1 1 0 002 0V4zM10 7a1 1 0 011 1v1h2a1 1 0 110 2h-3a1 1 0 01-1-1V8a1 1 0 011-1zM16 9a1 1 0 100 2 1 1 0 000-2zM9 13a1 1 0 011-1h1a1 1 0 110 2v2a1 1 0 11-2 0v-3zM7 11a1 1 0 100-2H4a1 1 0 100 2h3zM17 13a1 1 0 01-1 1h-2a1 1 0 110-2h2a1 1 0 011 1zM16 17a1 1 0 100-2h-3a1 1 0 100 2h3z"></path>
    </svg>
  ...
  def phone_outgoing(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M17.924 2.617a.997.997 0 00-.215-.322l-.004-.004A.997.997 0 0017 2h-4a1 1 0 100 2h1.586l-3.293 3.293a1 1 0 001.414 1.414L16 5.414V7a1 1 0 102 0V3a.997.997 0 00-.076-.383z"></path><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
    </svg>
  ...
  @doc "solid/currency-bangladeshi.svg"
  ...
  @doc "solid/arrow-narrow-left.svg"
  ...
  @doc "solid/arrow-circle-left.svg"
  ...
  @doc "solid/dots-circle-horizontal.svg"
  ...
  def rss(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M5 3a1 1 0 000 2c5.523 0 10 4.477 10 10a1 1 0 102 0C17 8.373 11.627 3 5 3z"></path><path d="M4 9a1 1 0 011-1 7 7 0 017 7 1 1 0 11-2 0 5 5 0 00-5-5 1 1 0 01-1-1zM3 15a2 2 0 114 0 2 2 0 01-4 0z"></path>
    </svg>
  ...
  @doc "solid/arrow-circle-right.svg"
  ...
  def zoom_in(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M5 8a1 1 0 011-1h1V6a1 1 0 012 0v1h1a1 1 0 110 2H9v1a1 1 0 11-2 0V9H6a1 1 0 01-1-1z"></path><path fill-rule="evenodd" d="M2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8zm6-4a4 4 0 100 8 4 4 0 000-8z" clip-rule="evenodd"></path>
    </svg>

    """
  end

  @doc "solid/arrow-sm-right.svg"
  ...
  @doc "solid/cube-transparent.svg"
  ...
  def zoom_out(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path><path fill-rule="evenodd" d="M5 8a1 1 0 011-1h4a1 1 0 110 2H6a1 1 0 01-1-1z" clip-rule="evenodd"></path>
    </svg>
  ...
  @doc "solid/document-download.svg"
  ...
  @doc "solid/switch-horizontal.svg"
  ...
  @doc "solid/arrow-circle-down.svg"
  ...
  def folder_download(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z"></path><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9v4m0 0l-2-2m2 2l2-2"></path>
    </svg>
  ...
  @doc "solid/arrow-narrow-down.svg"
  ...
  @doc "solid/phone-missed-call.svg"
  def phone_missed_call(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path><path d="M16.707 3.293a1 1 0 010 1.414L15.414 6l1.293 1.293a1 1 0 01-1.414 1.414L14 7.414l-1.293 1.293a1 1 0 11-1.414-1.414L12.586 6l-1.293-1.293a1 1 0 011.414-1.414L14 4.586l1.293-1.293a1 1 0 011.414 0z"></path>
    </svg>
  ...
  def folder_add(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z"></path><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 11h4m-2-2v4"></path>
    </svg>

    """
  end

  @doc "solid/filter.svg"
  ...
  @doc "solid/arrow-narrow-right.svg"
  ...
  @doc "solid/desktop-computer.svg"
  ...
  def finger_print(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M6.625 2.655A9 9 0 0119 11a1 1 0 11-2 0 7 7 0 00-9.625-6.492 1 1 0 11-.75-1.853zM4.662 4.959A1 1 0 014.75 6.37 6.97 6.97 0 003 11a1 1 0 11-2 0 8.97 8.97 0 012.25-5.953 1 1 0 011.412-.088z" clip-rule="evenodd"></path><path fill-rule="evenodd" d="M5 11a5 5 0 1110 0 1 1 0 11-2 0 3 3 0 10-6 0c0 1.677-.345 3.276-.968 4.729a1 1 0 11-1.838-.789A9.964 9.964 0 005 11zm8.921 2.012a1 1 0 01.831 1.145 19.86 19.86 0 01-.545 2.436 1 1 0 11-1.92-.558c.207-.713.371-1.445.49-2.192a1 1 0 011.144-.83z" clip-rule="evenodd"></path><path fill-rule="evenodd" d="M10 10a1 1 0 011 1c0 2.236-.46 4.368-1.29 6.304a1 1 0 01-1.838-.789A13.952 13.952 0 009 11a1 1 0 011-1z" clip-rule="evenodd"></path>
    </svg>
  ...
  @doc "solid/chart-square-bar.svg"
  ...
  def clipboard_check(assigns) do
    ...
    ~H"""
    <svg class={@class} fill={@fill} stroke={@stroke} aria-hidden="true" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path><path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm9.707 5.707a1 1 0 00-1.414-1.414L9 12.586l-1.293-1.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
    </svg>
